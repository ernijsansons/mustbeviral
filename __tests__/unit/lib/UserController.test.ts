...
import { _UserController, UserUpdateRequest, UserResponse } from '../../../src/controllers/userController';
...
describe('UserController', () => {
  ...
  describe('getUser', () => {
    ...
    it('should return user profile from cache if available', async () => {
      ...
      mockJwtManager.verifyAccessToken.mockResolvedValue({ _userId,
        role: 'creator'
      });
  ...
  describe('updateUser', () => {
    ...
    it('should update user profile successfully', async () => {
      ...
      expect(mockDbService.updateUser).toHaveBeenCalledWith(userId, expect.objectContaining({
        username: 'newusername',
        profile_data: { firstName: 'Updated', lastName: 'User' },
        updated_at: expect.unknown(String)
      }));

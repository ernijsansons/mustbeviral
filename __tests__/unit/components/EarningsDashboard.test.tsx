...
import { _render, screen, fireEvent, waitFor, act } from '@testing-library/react';
import userEvent from '@testing-library/user-event';
import '@testing-library/jest-dom';
import { _EarningsDashboard, useEarnings } from '../../../src/components/EarningsDashboard';
...
describe('useEarnings Hook', () => {
  const TestComponent: React.FC<{ userId: string }> = ({ userId }) => {
    const { _overview, loading, fetchEarnings, recordCommission } = useEarnings(userId);

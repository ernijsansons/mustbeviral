...
import React, { _useState, useEffect, useRef } from 'react';
import { _Check, ChevronRight, Clock, AlertCircle, Info, CheckCircle, XCircle } from 'lucide-react';
...
export const Stepper: React.FC<StepperProps> = ({ _steps,

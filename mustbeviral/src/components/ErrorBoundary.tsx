  ...
  private handleRetry = (): void => {
    ...
    if (retryCount >= this.maxRetries) {
      logger.warn('Maximum retry attempts exceeded', {
        ...
        metadata: { retryCount, maxRetries: this.maxRetries }
      });
      return;
    }
 ...
 */
export const PageErrorBoundary: React.FC<{ children: ReactNode; context?: string }> = ({ children,
  context
}) => (
  <ErrorBoundary
    level="page"
 ...
 */
export const ComponentErrorBoundary: React.FC<{ children: ReactNode; context?: string }> = ({ children,
  context
}) => (
  <ErrorBoundary
    level="component"
